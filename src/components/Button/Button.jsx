...
import { ButtonLikeWrapper, IconLike, IconLikeUse } from './Button.styled';
...
import { selectFavorites } from '../../redux/selectorsRedux/selectors';

export const ButtonLike = ({ item }) => {
  const [isLike, setIsLike] = useState(false);
  const dispatch = useDispatch();
  const likedCamps = useSelector(selectFavorites);
